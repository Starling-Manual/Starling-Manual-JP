...
このマニュアルは http://www.starling-framework.org[Starling Framework] の本格的な紹介を目的とします。
Starling は  _ActionScript 3_ を用いたクロスプラットフォームで動作する様々なアプリケーションを開発するために用いられるエンジンで、特に２Dゲーム開発を対象にしています。

ifdef::backend-html5[]
TIP: このドキュメントの link:manual.pdf[PDFバージョン] がダウンロード可能です。
endif::[]

このガイドでは、下記について学ぶ事ができます。

//原文：The technologies Starling was built upon and the principles it follows.
* Starling が構築されている基盤テクノロジーや、開発理念について
* 開発に使う IDE の選定や、プロジェクトの設定のやり方について
...
マニュアルの著者はこのマニュアルの内容に加えて、さらにたくさんの HOWTO やガイドを追記した本の執筆も行っています。
A step-by-step tutorial will lead you through the development of a *complete game*.
ステップ・バイ・ステップで記述されたチュートリアルは、ゲーム開発の最初から最後まで役に立つでしょう。

* 本について詳しくは http://gamua.com/blog/2016/09/the-starling-handbook/[Gamua ブログ] を参照してください。
* http://bit.ly/2dfNIQF[本のお試しプレビュー] がダウンロード可能です。
* ここに http://eepurl.com/chQGpD[サインアップ] すると本の完成時にお知らせを受ける事ができます！
====
...
さて、ここまでで _Starling Manual_ は終了です。
様々な分野をカバーできていたと思うのですが。
...
身につけた知識をシェアしたいですか？
それともまだわからない事があり、質問をしたいですか？
Starling コミュニティはあなたの手助けを待っています。
ぜひ、オフィシャルのフォーラムを訪れてください。 http://forum.starling-framework.org[Starling Forum].

=== まだ物足りない方へ

Starling についてこのドキュメントの内容ではまだまだ不十分だと思う人は、ここに http://eepurl.com/chQGpD[サインアップ] してください。
http://gamua.com/blog/2016/09/the-starling-handbook/[Starling Handbook] の発売時にお知らせします！
Starling Handbookは、このマニュアルの全てのコンテンツに加えて、さらにあなたのプロジェクト開発に役立つ情報をお伝えします。
