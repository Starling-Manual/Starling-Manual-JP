# The Starling Manual - Japanese

The goal of the manual is to provide an extensive introduction to the [Starling Framework][1].
...
This repository provides the basis for the [Japanese online manual](http://manual.starling-framework.org/jp).
...
If so, please simply open up an issue in [this repository](https://github.com/Starling-Manual/Starling-Manual), stating the language you want to help with.
